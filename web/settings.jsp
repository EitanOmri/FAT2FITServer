        ...
        <form name="changeWeight" method="get" action="/controller/UserController/update">
            <div data-role="fieldcontain">
                <label for="Weight">change weight (in Kg):
                    <input type="number" name="weight" id="weight" value="<%= request.getAttribute("weightEdit")%>"/></label>
            </div>
                <div data-role="fieldcontain">
                <label for="Height">change height (in cm):
                    <input type="number" name="height" id="height" value="<%= request.getAttribute("heightEdit")%>"/>
